...
function switchToPrimInfo() {
  ...
  desc.innerText = "Prim's algorithm begins by choosing an initial cell, " + " then adding all of its neighbors into the 'frontier.'" + " From there, the algorithm visits one of the frontier cells, and adds" + " its neighbors to the frontier as well. This pattern continues until" + " every cell in the grid are visited.";
}
